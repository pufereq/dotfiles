...
class Fridge():
  ...
  [b yellow]fridge:[/b yellow]
    [bold cyan]eat raw:[/bold cyan]
      [magenta]bread:[/magenta] [b i blue]+8 hunger; -1 fun[/b i blue]
      [magenta]vegetables:[/magenta] [b i blue]+5 hunger; +2 fun[/b i blue]
      [magenta]fruits:[/magenta] [b i blue]+7 hunger; +4 fun[/b i blue]
      [magenta]eggs:[/magenta] [b i blue]+3 hunger; -2 fun[/bold italic blue]
      [magenta]flour:[/magenta] [b i blue]+1 hunger; -10 fun; -5 hygiene[/b i blue]
      [magenta]meat:[/magenta] [b i blue]+6 hunger; -4 fun[/b i blue]
        ''')
        choice = Prompt.ask(
            'eat raw',
            choices=['bread',
